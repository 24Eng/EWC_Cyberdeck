void risingEdgeLightControl(int funAddress){
  pixels.setPixelColor(funAddress, pixels.Color(0, 0, maxBrightness));
  pixels.show();
}

void fallingEdgeLightControl(int funAddress){
//  pixels.setPixelColor(funAddress, pixels.Color(0, maxBrightness, 0));
  colorWheel(funAddress, defaultColor[funAddress]);
  pixels.show();
}
